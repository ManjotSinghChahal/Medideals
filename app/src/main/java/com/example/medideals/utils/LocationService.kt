...
class LocationService : Service(), LocationListener {
    ...
    override fun onLocationChanged(location: Location) {
        ...
        Log.e("runLocationMethod",location.latitude.toString())
        Log.e("runLocationMethod",location.longitude.toString())
        ...
        if (GlobalHelper.CURRENT_LAT == 0.0 && GlobalHelper.CURRENT_LNG == 0.0) {
            ...
            sendMessageToUI(GlobalHelper.CURRENT_LAT.toString(), GlobalHelper.CURRENT_LNG.toString())

/*
            GlobalHelper.PREV_LAT = location.latitude
            GlobalHelper.PREV_LNG = location.longitude
            ...
            if (GlobalHelper.distance(location.latitude.toFloat(), location.longitude.toFloat(), GlobalHelper.PREV_LAT.toFloat(), GlobalHelper.PREV_LNG.toFloat()) > 2)
            {
                sendMessageToUI(location.latitude.toString(), location.longitude.toString())
                GlobalHelper.PREV_LAT = location.latitude
                GlobalHelper.PREV_LNG = location.longitude
